...
const GanttTest = () => {
    ...
    const getProgressPercent = (start_date, due_date, completion_date) => {
        if (
            ...
            const totalNumberOfDays = moment(start_date).diff(
                moment(due_date),
                "days"
            );
            // console.log("Total number of days:  ", totalNumberOfDays)

            let taskCompletedInDays = moment(start_date).diff(
                moment(completion_date),
                "days"
            );
            ...
            console.log("returned percent is", progressPercent)
