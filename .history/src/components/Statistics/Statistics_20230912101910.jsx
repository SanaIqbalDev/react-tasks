    ...
    return (
        <>
            ...
            <div className="stats-container">
                ...
                <div className="stats-item" style={{ maxWidth: "100%" }}><CompletedTasks values={TaskCompeletion()} /></div>
                <div className="stats-item" style={{ maxWidth: "100%" }}><Insights style={{ margin: "0 auto" }} /></div>
                <div className="stats-item" style={{ maxWidth: "100%" }}></div><GanttTest className="stats-item" /></div>
        </div >
        </>
    );
};
