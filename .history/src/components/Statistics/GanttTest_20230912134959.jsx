    ...
    const tasks = [
        {
            ...
            id: "0",
            type: "task",
            progress: getProgressPercent(moment("2023-09-01"), moment("2023-09-10"), moment("2023-09-05")),
            isDisabled: true,
            styles: { progressColor: progressCol, progressSelectedColor: progressSelColor },
        },
        ...
        },
        {
            ...
            id: "4",
            type: "task",
            progress: getProgressPercent("2023-09-8", "2023-09-13", "2023-09-12"),
            isDisabled: true,
            styles: { progressColor: progressCol, progressSelectedColor: progressSelColor },
        },

        {
            ...
            id: "5",
            type: "task",
            progress: getProgressPercent("2023-09-3", "2023-09-13", "2023-09-12"),
            isDisabled: true,
            styles: { progressColor: progressCol, progressSelectedColor: progressSelColor },
        },
        {
