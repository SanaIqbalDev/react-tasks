    ...
    return (
        <>
            ...
            <div className="stats-container">
                ...
                <div className="stats-item" style={{ maxWidth: "100%", margin: "30px" }}><CompletedTasks values={TaskCompeletion()} /></div>
                <div className="stats-item" style={{ maxWidth: "100%", margin: "30px" }}><Insights /></div>
