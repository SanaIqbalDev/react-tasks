    ...
    return (
        <>
            ...
            <div className="stats-container">
                <div className="stats-item"><CompletedTasks values={TaskCompeletionStats()} style={{ margin: "0 auto" }} /></div>
                <div className="stats-item"><Insights values={TaskPriorityStats()} /></div>
                <div className="stats-item"><ActivityMetrics /></div>
            </div>
            <div>
                <GanttTest />
            </div>
