...
const GanttTest = () => {
    ...
    const tasks = [
        ...
        },
        {
            ...
            id: "3",
            type: "task",
            progress: getProgressPercent(moment("2023-09-13"), moment("2023-09-20"), moment()),
            isDisabled: true,
            styles: {
                progressColor: progressCol,
                progressSelectedColor: progressSelColor,
        ...
        },
        {
            ...
            id: "6",
            type: "task",
            progress: getProgressPercent(moment("2023-09-13"), moment("2023-09-26"), moment()),
            isDisabled: true,
            styles: {
                progressColor: progressCol,
                progressSelectedColor: progressSelColor,
        ...
        },
        {
            ...
            id: "7",
            type: "task",
            progress: getProgressPercent(moment("2023-09-25"), moment("2023-10-05"), moment()),
            isDisabled: true,
            styles: {
                progressColor: progressCol,
                progressSelectedColor: progressSelColor,
    ...
    return (
        <>
            <Gantt tasks={tasks} viewMode={view} barFill={35} rowHeight={50} barBackgroundColor="red" />
        </>
    );
};
