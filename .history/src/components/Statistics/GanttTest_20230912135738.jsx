...
const GanttTest = () => {
    ...
    const tasks = [
        {
            start: (new Date(2023, 9, 1).toLocaleString("gb")),
            end: (new Date(2023, 9, 10).toLocaleString("gb")),
...

        {
            ...
            id: "1",
            type: "task",
            progress: getProgressPercent("2023-09-05", "2023-09-08", undefined),
            isDisabled: true,
            styles: {
                progressColor: progressCol,
                progressSelectedColor: progressSelColor,
        ...
        {
            start: new Date(2023, 9, 8).toL,
            end: new Date(2023, 9, 13),
            name: "Task 5",
            id: "4",
            type: "task",
            progress: getProgressPercent("2023-09-08", "2023-09-13", "2023-09-10"),
            isDisabled: true,
            styles: {
                progressColor: progressCol,
                progressSelectedColor: progressSelColor,
...

        {
            ...
            id: "5",
            type: "task",
            progress: getProgressPercent("2023-09-03", "2023-09-13", "2023-09-12"),
            isDisabled: true,
            styles: {
                progressColor: progressCol,
                progressSelectedColor: progressSelColor,
