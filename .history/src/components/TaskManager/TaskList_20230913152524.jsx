    ...
    <>
      <div className={styles.taskList}>
        ...
        <div className={styles.categoryHeading}>
          <label
            className={selectedCat === "all" ? styles.selectedCategory : styles.category}
            onClick={() => {
              CategoryClicked("all");
            }}
          >
          ...
          <label
            className={
              selectedCat === "official" ? styles.selectedCategory : styles.category
            }
            onClick={() => {
          ...
          <label
            className={
              selectedCat === "household" ? styles.selectedCategory : styles.category
            }
            onClick={() => {
          ...
          <label
            className={
              selectedCat === "personal" ? styles.selectedCategory : styles.category
            }
            onClick={() => {
