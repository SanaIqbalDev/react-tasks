...
function Home({ tasks, setTasks, idNew }) {
    ...
    const UpdateItem = (taskName, taskDetail, taskDueDate, taskCategory, taskPriority, taskId) => {
    ...
    return (
        <>
            <div className={styles.container}>
                ...
                {isEdit && <EditTaskForm task={selectedTask} onSubmit={UpdateItem} closeForm={closeForm} />}
            </div>
        </>
    );
}
