        ...
        <div>
            ...
            <form className='add-task-form' onSubmit={submitForm}>
                ...
                <div className='input-section'>
                    ...
                    <input className='input-text' type='date' min={newduedate} data-date-format="DD MMMM YYYY" required placeholder='Add task due date' value={dueDate} onChange={(e) => { setDueDate(e.target.value) }} />
                </div>
