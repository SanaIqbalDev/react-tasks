...
const TaskForm = ({ onSubmit }) => {
    ...
    console.log("Formatted date is " ,newduedate)
        ...
        <div>
            ...
            <form className='add-task-form' onSubmit={submitForm}>
                ...
                <div className='input-section'>
                    ...
                    <input className='input-text' type='date' max={newduedate} required placeholder='Add task due date' value={dueDate} onChange={(e) => { setDueDate(e.target.value) }} />
                </div>
