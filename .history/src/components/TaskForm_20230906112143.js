...
const TaskForm = ({ onSubmit }) => {
    ...
    const dateToday = new Date().toLocaleDateString("en",{year:"4-digit",month:"2-digit", day:"2-digit"})
        ...
        <div>
            ...
            <form className='add-task-form' onSubmit={submitForm}>
                ...
                <div className='input-section'>
                    ...
                    {/* {console.log(Date())} */}
                    {/* min={'2023-09-26'} */}
                    <input className='input-text' type='date' required min={dateToday} placeholder='Add task due date' value={dueDate} onChange={(e) => { setDueDate(e.target.value) }} />
                </div>
